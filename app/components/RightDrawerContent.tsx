...
import { Text, HStack, VStack, Heading, Box, ScrollView } from "native-base";
...
const RightDrawerContent: React.FC<DrawerContentComponentProps> = ({
  ...
  return (
    <SafeAreaView>
      <ScrollView minH={"100%"} showsVerticalScrollIndicator={false}>
        <TouchableOpacity
          style={{
        ...
        <RightDrawerMenu navigation={props.navigation} />
      </ScrollView>
    </SafeAreaView>
  );
};
